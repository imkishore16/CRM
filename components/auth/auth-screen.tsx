...
export default function AuthScreen({ authType }: { authType?: SignInFlow }) {
  ...
  return (
    <div className="flex min-h-screen flex-col md:flex-row">
      {/* Left side - Auth form */}
      <div className="flex w-full items-center justify-center bg-white px-4 py-12 md:w-1/2 md:py-0">
      ...
      <div className="hidden w-1/2 bg-black md:block">
        <div className="flex h-full flex-col items-center justify-center p-12">
          <div className="mb-8 text-center">
            ...
            <p className="text-gray-400">Manage your data and connect with customers like never before</p>
          </div>

          <div className="relative h-[400px] w-full max-w-lg rounded-xl bg-gradient-to-br from-gray-800 to-gray-900 p-1">
            <div className="absolute inset-0 flex items-center justify-center rounded-lg">
              <span className="text-lg text-gray-400">Dashboard Preview</span>
            </div>
          </div>
        </div>
      </div>
